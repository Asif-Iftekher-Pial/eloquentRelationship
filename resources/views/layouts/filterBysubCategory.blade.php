    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            ...
            <div style="text-align: center">
                <strong>Filter by Sub-Category Product</strong>
            </div>
            <br>
            <div class="card">
                <div class="card-header">{{ __('Filtered By sub cat') }}</div>
                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($productsThroughsubcategories as $item)
                            @foreach ($item->productsbysubcat as $value )
                            <tr>
